...
import { Clock, Globe, Check, X, Edit3, Info, Trash2, ChevronDown, ChevronRight } from 'lucide-react';
import { getStatusColor } from '../status';

// Collapsible header of a profile card: selection checkbox, avatar, editable
// name, last-run date, status dot, delete button and expand chevron.
